...
module.exports = {
	config: {
		name: "ytb",
		version: "1.13",
		author: "NTKhang | rehat-- | MarianCross",
		countDown: 5,
		role: 0,
	...
	langs: {
		vi: {
			...
			video: "video",
			audio: "âm thanh",
			downloading: "⬇ | Rudeus Đang tải xuống %1 \"%2\"",
			downloading2: "⬇ | Rudeus tải xuống %1 \"%2\"\n🔃 Tốc độ: %3MB/s\n⏸ Đã tải: %4/%5MB (%6%)\n⏳ Ước tính thời gian còn lại: %7 giây",
		...
		en: {
			...
			video: "video",
			audio: "audio",
			downloading: "⬇ | Rudeus Downloading %1 \"%2\"",
			downloading2: "⬇ | Rudeus Downloading %1 \"%2\"\n🔃 Speed: %3MB/s\n⏸ Downloaded: %4/%5MB (%6%)\n⏳ Estimated time remaining: %7 seconds",
