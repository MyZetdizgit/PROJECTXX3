...
module.exports.onStart = async function({ api, event, args }) {
    ...
    let styleIndex = 0; // Default style index
    if (args.includes("-s")) {
    ...
    const apiUrl = `https://zetreal-sjjz.onrender.com/generate?prompt=${encodeURIComponent(prompt)}&modelIndex=${modelIndex}&styleIndex=${styleIndex}&ratio=${ratio}`;
